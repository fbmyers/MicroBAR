...
public class LAMP_UI extends PApplet {
...
static final float UI_VERSION = 0.2f;
...
public void draw_wells() {
  ...
  for (int i=0;i<96;i++) {
    ...
    fill(0); 
    text(Float.toString(data[i]),w_x,w_y+well_diam*0.7f); 
  }  
}

public void draw_plots() {
...
public void parse_data(String data_string) {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#F0F0F0", "LAMP_UI" });
  }
}
